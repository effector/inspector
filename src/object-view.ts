    ...
    ({ store: $props }) => {
      ...
      variant({
        ...
        cases: {
          //#region
          String: ({ store }) =>
            Content.string({ text: ['"', remap(store, 'value'), '"'] }),
          Number: ({ store }) =>
            Content.number({ text: remap(store, 'value') }),
          BigInt: ({ store }) =>
            Content.number({
          ...
          Boolean: ({ store }) =>
            Content.boolean({ text: remap(store, 'value') }),
          Null: () => Content.keyword({ text: 'null' }),
          Undefined: () => Content.keyword({ text: 'undefined' }),
          Symbol: ({ store }) =>
            Content.symbol({ text: remap(store, 'value') }),
          ...
          Array({ store: $variantSource }) {
            const [$value, $opened] = remap($variantSource, [
              'value',
              'opened',
            ]);
            h('span', () => {
          ...
          __({ store: $variantSource }) {
            h('span', () => {
              const [$type, $value, $opened] = remap($variantSource, [
                'type',
                'value',
                'opened',
              ]);
